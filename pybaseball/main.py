...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python main.py [game_logs|probable_pitchers|compute_stats|season_stats|yahoo_player_data|compute_auction_valuations|compute_player_value_snapshots|all] [--force]")
        sys.exit(1)
